...
# ----------------------------------------------------------------------------------------------------------------------
#
#      Callable script to start a training on Pheno4d dataset
#
# ----------------------------------------------------------------------------------------------------------------------
#
...
# Dataset
from datasets.Pheno4d import Pheno4dDataset
...
if __name__ == '__main__':
    ...
    dataset = Pheno4dDataset(config.dataset.split('_')[1], config.input_threads)
